package lavagames.towers.spritesheet

import com.badlogic.gdx.Gdx
import java.io.FileFilter

class LpcSpriteSheetHelper(val basePath: String = "localfiles/lpcdefault/") {
	/*
	...
	val categories = listOf(
			...
			LpcSpriteSheetCategoryDefinition("clothes", setOf("torso"),2),
...
//			LpcSpriteSheetCategoryDefinition("clothes", setOf("torso", "chain"),2),
			...
			LpcSpriteSheetCategoryDefinition("belts", setOf("belt"),3),
			LpcSpriteSheetCategoryDefinition("shoes", setOf("feet"),2),
			LpcSpriteSheetCategoryDefinition("gloves", setOf("hands"),2),
			LpcSpriteSheetCategoryDefinition("hats & helmets", setOf("head"),3),
