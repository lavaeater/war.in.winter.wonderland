package lavagames.towers.ui.charactereditor
...
import lavagames.towers.mvvm.commandTextButton
import lavagames.towers.spritesheet.RenderableThing

class CharacterEditorView(
		batch: Batch,
		viewModel: CharacterEditorViewModel): ViewBase<CharacterEditorViewModel>(batch, viewModel) {
